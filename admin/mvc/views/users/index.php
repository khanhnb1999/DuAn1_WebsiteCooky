                ...
                <table class="table table-hover text-center border border-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="?url=user/update/<?=$value['user_id']?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                                <a onclick="return confirm('Bạn có muốn xóa không!!!')"
                                    href="?url=user/delete/<?=$value['user_id']?>" class="btn btn-danger"><i class="fas fa-backspace"></i></a>
                            </td>
                        </tr>
                        <?php endforeach;?>
                    </tbody>
                ...
                <?php
                    ...
                    for ($i = 1; $i <= $total_page; $i++) {
                        if ($i == $page) {
                            ...
                            echo "<a href='?url=user/index/$i' class=' btn btn-secondary mx-1'>$i</a>";
                        }
                    }
                ?>
