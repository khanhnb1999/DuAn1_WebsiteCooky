...
<div class="form__product">
        <div class="content border border-5 p-3">
                ...
                <form action="<?php echo SITE_URL; ?>/product/updateFormula/<?= $value['dish_id'] ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="item">
                                        <select name="cate_id" class="form-control input__control">
                                                ...
                                                <?php if($cat['catalog_id'] == $value['catalog_id']) : ?>
                                                        <option selected value="<?= $cat['catalog_id'] ?? 0 ?>"><?= $cat['catalog_name'] ?></option>
                                                <?php else: ?>
                                                        <option value="<?= $cat['catalog_id'] ?? 0 ?>"><?= $cat['catalog_name'] ?></option>
                                                <?php endif; ?>
                                                <?php endforeach; ?>
                                        </select>
                                </div>
